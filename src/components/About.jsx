...
const About = () => {
  return (
    <div className="md:px-10 px-7 sm:max-w-[1024px] sm:mx-auto w-full">
      <div className="">
        <h2 className="sm:text-[64px] text-[39px] leading-[47px] sm:leading-[83px] font-poppins mb-4 sm:mb-8 ">
          One company,
